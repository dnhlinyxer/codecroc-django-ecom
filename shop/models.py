...
class Category(models.Model):
    ...
    image = models.ImageField('圖片', null=True, default=None, upload_to=path_and_rename)
...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, blank=True, null=True, on_delete=models.SET_NULL, verbose_name='產品類別')
...
class Order(models.Model):
    ...
    customer = models.ForeignKey(User, on_delete=CASCADE, verbose_name='客戶')
    created_at = models.DateField('建立於', auto_now_add=True)
    updated_at = models.DateField('更新於', auto_now=True)
...
class Mapping(models.Model):
    order = models.ForeignKey(Order, on_delete=CASCADE, verbose_name='訂單')
    product = models.ForeignKey(Product, on_delete=CASCADE, verbose_name='產品')
